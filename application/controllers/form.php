          ...
          <div class="box box-primary">
            <form role="form" action="<?php echo $action?>" method="post" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                  <div class="form-group <?php if(form_error('mp_b')!=''){ echo 'has-error';}?> ">
                                    <select name="mp_b"  id="mp_b" onchange="codigo()" class="form-control">
                                      <option value="">SELECCIONE</option>
                                      <?php
                                          if(!empty($tipos)){
                            ...
                            <tr>
                                ...
                                <td>
                                  <div class="form-group <?php if(form_error('mp_c')!=''){ echo 'has-error';}?> ">
                                    <input type="text" class="form-control" name="mp_c" id="mp_c" <?php echo $readonly ?> value="<?php if(validation_errors()!=''){ echo set_value('mp_c');}else{ echo  $producto->mp_c;}?>">
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url().'producto_comercial/';echo $opc_id ?>" class="btn btn-default">Cancelar</a>
              </div>
    ...
    <script >
      ...
      function uploadAjax() {
            ...
            function codigo(){
              ...
              if (id1 != 0 && id2 != 0) {
              $.ajax({
                    url: base_url+"producto_comercial/traer_codigo/"+id1+"/"+id2,
                    type: 'POST',
                    success: function(dt){
