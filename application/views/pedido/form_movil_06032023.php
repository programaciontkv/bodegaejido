                                  ...
                                  $n=0;
                                    foreach($cns_det as $rst_det) {
                                        ...
                                        <tr>
                                            ...
                                            <td  hidden><input type="text" id="inventario<?PHP echo $n ?>" name="inventario<?PHP echo $n ?>" lang="<?PHP echo $n ?>" style="text-align:right" class="form-control" value="<?php echo str_replace(',', '', number_format($rst_det->inventario, $dcc)) ?>" readonly></td>
