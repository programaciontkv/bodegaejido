                          ...
                          <tr>
                            ...
                            <td >
                              <div class="form-group <?php if(form_error('ped_dir_cliente')!=''){ echo 'has-error';}?> ">
                                <input maxlength="80" type="text" class="form-control" name="ped_dir_cliente" id="ped_dir_cliente" value="<?php if(validation_errors()!=''){ echo set_value('ped_dir_cliente');}else{ echo $pedido->ped_dir_cliente;}?>" <?php echo $readonly?>>
