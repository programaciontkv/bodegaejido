    ...
    <tr>
        ...
        <td rowspan="2" width="52%">
            <table id="encabezado2" width="100%">
                ...
                <tr>
                    <th colspan="2" style="font-size:20px">No. <?php echo $nota->ncr_numero?></th>
                </tr>  
                <tr>
                    <td><strong> <?php echo utf8_encode('Fecha de Emisión:') ?> </strong><?php echo $nota->ncr_fecha_emision?></td>
                </tr>    
                <tr>
                ...
                <tr>    
                    <td><?php echo $nota->ncr_fec_hora_aut?></td>
                </tr>    
                <tr>
                    <?php 
                ...
                <tr> 
                    <td colspan="2">
                        <img src="<?php echo base_url();?>barcodes/<?php echo $nota->ncr_clave_acceso?>.png" alt="" width="350px" height="70px">
                    </td>
                </tr> 
                <tr>
    ...
    <tr>
        <td colspan="2">
            <table id="encabezado3" width="100%">
                <tr>
                    <td><strong><?php echo utf8_encode('Razón Social: ')?></strong>  <?php echo ucwords(strtolower($nota->ncr_nombre))?></td>
                </tr>    
                <tr>
                    <td><strong>Email: </strong><?php echo strtolower($nota->ncr_email)?></td>
                    <td><strong> <?php echo utf8_encode('Cédula/RUC:') ?> </strong><?php echo $nota->ncr_identificacion?></td>
                </tr>    
                <tr>
                    <td><strong><?php echo utf8_encode('Dirección:')?> </strong><?php echo ucwords(strtolower($nota->ncr_direccion))?></td>
                ...
                <tr>
                    <td><strong>Comprobante que se modifica:</strong> <?php echo $nota->ncr_num_comp_modifica?></td>
                </tr>   
                <tr>    
                    <td><strong>Fecha <?php echo utf8_encode('emisión')?> (Comprobante a modificar):</strong> <?php echo $nota->ncr_fecha_emi_comp?></td>
                </tr>    
                <tr>    
                    <td><strong><?php echo utf8_encode('Razón de modificación: ')?></strong> <?php echo ucfirst(strtolower($nota->ncr_motivo))?></td>
                </tr>    
            </table>
        </td>
    </tr>      
            ...
            <table id="detalle" width="95%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width: 10px !important;"><?php echo ucwords(strtolower($det->pro_descripcion))?></td>
