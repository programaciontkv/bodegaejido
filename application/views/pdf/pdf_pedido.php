                ...
                <table class="encabezado5" width="100%">
                    <tr>
                        <td style="font-size:12px">
                            <?php echo $pedido->emp_nombre; ?>
                        </td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td rowspan="6" width="20%"><img src="<?php echo base_url() . 'imagenes/' . $pedido->emp_logo ?>"
                                width="120px" height="70px"></td>
                    </tr>
                    <tr>
                        <td style="font-size:12px">
                            <?php echo $pedido->emp_identificacion; ?>
                        </td>
                    </tr>
                    <tr>
                        <td style="font-size:12px">
                            <?php echo $pedido->emp_ciudad . "-" . $pedido->emp_pais; ?>
                        </td>
                    </tr>
                    <tr>
                        <td style="font-size:12px">
                            <?php echo "TELEFONO: " . $pedido->emp_telefono ?>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td colspan="2">
                <div style="text-align:center;">
                    <p class="titulo_p"><strong class="titulo_p">
                            <?php echo ('PEDIDO DE VENTA') ?>
                        </strong> </p>
                </div>
            </td>
        </tr>
        <tr>
            <td colspan="2" class="sub_titulo" style="text-align: right;">
                <?php echo (' N°: ') ?>
            ...
            <td colspan="2">
                <table id="encabezado3" width="100%">
                    ...
                    <tr>
                        ...
                        <td><strong>
                                <?php echo utf8_encode('Fecha emisión:') ?>
                            </strong>
                            <?php echo $pedido->ped_femision ?>
                        </td>
                    ...
                    <tr>
                        ...
                        <td width="100px">
                            <?php echo $pedido->ped_ruc_cc_cliente ?>
                        </td>
                        <td width="100px"></td>
                        <td><strong> Fecha entrega: </strong>
                            <?php echo $pedido->ped_fentrega ?>
                        </td>
                    ...
                    <tr>
                        ...
                        <td width="100px">
                            <?php echo strtolower($pedido->ped_email_cliente) ?>
                        </td>
                        <td width="100px"></td>
                        <td></td>
                    </tr>
                    <tr>
                        ...
                        <td width="120px">
                            <?php echo $pedido->ped_tel_cliente ?>
                        </td>
                        <td width="100px"></td>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <?php echo (ucwords(strtoupper($dire))) ?>
                        </td>
    ...
    <table id="detalle" width="100%" class="table table-bordered table-list table-hover table-striped page-break">
        <thead class="sub_titulo">
            <tr>
                ...
                if ($etq != 'hidden') {
                    ?>
                    <th <?php echo $etq ?> style="<?php echo $width ?>"> <strong>
                            <?php echo ('Imagen') ?>
                        </strong> </th>
                <?php }
                ?>
        ...
        <tbody>
            ...
            foreach ($cns_det as $det) {
                ...
                <tr>
                    ...
                    <td class="numerico">
                        <?php echo number_format($det->det_cantidad, $dcc) ?>
                    </td>
                    <td class="numerico">
                        <?php echo number_format(doubleval($det->det_vunit), $dec) ?>
                    </td>
                    ...
                    <td class="numerico">
                        <?php echo number_format($det->det_total, $dec) ?>
                    </td>
                </tr>
                <?php
            }
        ...
        <tbody>
            <tr>
                ...
                <td class="numerico">
                    <?php echo number_format($pedido->ped_tdescuento, $dec) ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="numerico">
                    <?php echo number_format($pedido->ped_sbt0, $dec) ?>
                </td>
            </tr>
            <tr>
                <th colspan="2">TARIFA 12%</th>
                <td class="numerico">
                    <?php echo number_format($pedido->ped_sbt12, $dec) ?>
                </td>
            </tr>
            <tr>
                <th colspan="2">IVA 12%</th>
                <td class="numerico">
                    <?php echo number_format($pedido->ped_iva12, $dec) ?>
                </td>
            </tr>
            <tr>
                <th colspan="2">TOTAL</th>
                <td class="numerico">
                    <?php echo number_format($pedido->ped_total, $dec) ?>
                </td>
            </tr>
            <tr>
                <th>OBSERVACIONES:</th>
...
<style type="text/css">
    *,
    ...
    #firmas {
        ...
        margin-right: auto;
        text-align: left;
        /* Para que deje el texto dentro de la tabla hacia la izquierda */
