		...
		<div class="box box-body">
			...
			<div class="row">
				<div class="col-md-12">
					...
					?>
						<a href="<?php echo base_url();?>impuesto/nuevo" class="btn btn-success btn-flat"><span class="fa fa-plus"></span>Crear impuesto</a>
					<?php 
					}
					?>
				</div>	
						...
						?>
							<tr>
								...
								<td>
									 ...
									 <img width="25px" height="25px" onclick="cambiar_es(2,<?php echo $impuesto->por_id ?>)" src="../imagenes/activo.png"> 
								...
								?>
								<td>
									 <img width="25px" height="25px" onclick="cambiar_es(1,<?php echo $impuesto->por_id ?>)" src="../imagenes/inactivo.png"> 
